...
module Wasminna
  class ASTParser
    ...
    Context = Data.define(:types, :functions, :tables, :globals, :data, :locals, :labels, :typedefs) do
      def initialize(types: [], functions: [], tables: [], globals: [], data: [], locals: [], labels: [], typedefs: [])
        super
      end

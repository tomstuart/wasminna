...
module Wasminna
  class ASTParser
    ...
    Context = Data.define(:types, :functions, :tables, :globals, :elem, :data, :locals, :labels, :typedefs) do
      def initialize(types: [], functions: [], tables: [], globals: [], elem: [], data: [], locals: [], labels: [], typedefs: [])
        super
      end
    ...
    def parse_normal_instruction
      ...
      in 'local.get' | 'local.set' | 'local.tee' | 'global.get' | 'global.set' | 'br' | 'br_if' | 'call' | 'table.get' | 'table.set' | 'memory.init' | 'data.drop' => opcode
        index_space =
          case opcode
